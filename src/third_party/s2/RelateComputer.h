...
#include "PointLocator.h" // for RelateComputer composition
#include "LineIntersector.h" // for RelateComputer composition
#include "NodeMap.h" // for RelateComputer composition
#include "Coordinate.h" // for RelateComputer composition
