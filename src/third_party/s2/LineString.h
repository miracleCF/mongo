...
#include "platform.h" // do we need this ?
#include "Geometry.h" // for inheritance
#include "Lineal.h" // for inheritance
#include "CoordinateSequence.h" // for proper use of auto_ptr<>
#include "Envelope.h" // for proper use of auto_ptr<>
 ...
 */
class LineString: public virtual Geometry, public Lineal {
