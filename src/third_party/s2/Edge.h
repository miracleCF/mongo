...
#include "GraphComponent.h" // for inheritance
#include "Depth.h" // for member
#include "EdgeIntersectionList.h" // for composition
#include "CoordinateSequence.h" // for inlines
